...
7월 썸머 베케이션 기준으로 ①크레딧 미션 4,500포 공통 통일 ②이벤트 대출 이포 유지 (원금 미션 1% 수치 추가) ③50만 이벤트 행 삭제 ④비교 테이블 합계 재계산 ⑤웨이팅 보상 할인 테이블 기준값 통일 ⑥한도상향 수치 수정.

[처방]
① 크레딧 미션 수치 → 4,500포 공통 통일 (10/20/30/50만 비교 테이블 + 한도상향 섹션)
② 이벤트 대출 원금 미션 → "감면"에서 금액별 1% 수치로 변경 (10만:1,000포 / 20만:2,000포 / 30만:3,000포)
③ 50만 원 이벤트 대출 행 → 삭제 (7월 썸머 베케이션 정책: 50만 이벤트 없음)
④ 웨이팅 보상 할인 테이블 → 4,500포 기준 20셀 × 4파일 전체 교체
   - Clean: Box 2,250(50%), VIP 2,475(45%), Royal 2,700(40%), Standard 2,925(35%), Original 3,150(30%)
   - Non-Clean: Box 3,375(25%), VIP 3,600(20%), Royal 3,825(15%), Standard 4,050(10%), Original 4,275(5%)
   - One: Box 2,700(40%), VIP 2,925(35%), Royal 3,150(30%), Standard 3,375(25%), Original 3,600(20%)
   - Several: Box 3,600(20%), VIP 3,825(15%), Royal 4,050(10%), Standard 4,275(5%), Original 4,500(0%)
⑤ 한도상향 섹션 크레딧 미션 수치 수정 (20만:5,000→4,500, 할인2,500→2,250 / 30만:6,000→4,500, 할인3,000→2,250 / 50만:6,000→4,500, 할인3,000→2,250)
⑥ 롸잇나우 한도상향 크레딧 미션 수치 수정 (20만:5,000→4,500 / 30만:6,000→4,500 / 50만:12,000→4,500)
