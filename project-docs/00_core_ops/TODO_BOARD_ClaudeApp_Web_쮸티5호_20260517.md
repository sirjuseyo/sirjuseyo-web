...
| T-028 | WT-028 | - | **진행중(In-Progress)** | 쇼핑 대출 페이지 누락 콘텐츠 "이 대출방식이 특별한 이유" 추가 | 쮸티5호 | 2026-06-09 | 【파일】`loan-match/shopping.html` |
| T-029 | WT-029 | - | **진행중(In-Progress)** | 쇼핑 대출 페이지 누락 콘텐츠 "꼭! 확인해요" 추가 | 쮸티5호 | 2026-06-09 | 【파일】`loan-match/shopping.html` |
| T-030 | WT-030 | - | **진행중(In-Progress)** | 쇼핑 대출 페이지 SEC-10 출시예정 이미지 섹션 삭제 | 쮸티5호 | 2026-06-09 | 【파일】`loan-match/shopping.html` |
| T-031 | WT-031 | - | **진행중(In-Progress)** | 쇼핑 대출 페이지 CTA 버튼 위치 변경 + 버튼명 변경 | 쮸티5호 | 2026-06-09 | 【파일】`loan-match/shopping.html` |
| T-032 | WT-032 | - | **진행중(In-Progress)** | GitHub Pages `.nojekyll` 추가 — `_` 시작 이미지 404 수정 | 쮸티5호 | 2026-06-10 | 【파일】`.nojekyll` (레포 루트 신규) |
