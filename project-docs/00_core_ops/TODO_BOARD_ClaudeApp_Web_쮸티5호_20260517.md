...
| T-035 | 스토어 배지 복원 + 사이즈 균등화 | 완료 | - | - | - | - | - | 쮸티5호 | 2026-06-16 | 커밋 `cbca6c2` |
| T-036 | Legal-top 배지 포맷 + 등록번호 라인 분리 | 완료 | - | - | - | - | - | 쮸티5호 | 2026-06-16 | 커밋 `cbca6c2` |
| T-037 | Logo-copy 컬러 보라 변경 | 완료 | - | - | - | - | - | 쮸티5호 | 2026-06-16 | 커밋 `cbca6c2` |
| T-038 | Legal-bottom 22px + 글머리 + 쌍따옴표 | 완료 | - | - | - | - | - | 쮸티5호 | 2026-06-16 | 커밋 `cbca6c2` |
| T-039 | 써주세요연계대부 corp-box 스타일 수정 | 완료 | - | - | - | - | - | 쮸티5호 | 2026-06-16 | 커밋 `cbca6c2` |
| T-040 | 통계 텍스트 변경 | 완료 | - | - | - | - | - | 쮸티5호 | 2026-06-16 | 커밋 `cbca6c2` |
| T-041 | EXPLORE 1/2/3 그룹 배너 + 컬러 코딩 | 완료 | - | - | - | - | - | 쮸티5호 | 2026-06-16 | 커밋 `cbca6c2` |
| T-042 | 히어로 박스 연한 배경 전환 | 완료 | - | - | - | - | - | 쮸티5호 | 2026-06-16 | 커밋 `cbca6c2` |
| T-043 | ARRIVE 클로징 배너 추가 | 완료 | - | - | - | - | - | 쮸티5호 | 2026-06-16 | 커밋 `cbca6c2` |
| T-044 | AI 카드 타이틀 변경 + 인용문 삭제 | 완료 | - | - | - | - | - | 쮸티5호 | 2026-06-16 | 커밋 `cbca6c2` |
...
| T-035 | WT-035 | cbca6c2 | **진행중(In-Progress)** | 스토어 배지 복원 + 사이즈 균등화 | 쮸티5호 | 2026-06-16 | 【파일】`index.html` / .store-platform width:75px |
| T-036 | WT-036 | cbca6c2 | **진행중(In-Progress)** | Legal-top 배지 포맷 + 등록번호 라인 분리 | 쮸티5호 | 2026-06-16 | 【파일】`index.html` / 배지+등록번호+등록시도명칭 |
| T-037 | WT-037 | cbca6c2 | **진행중(In-Progress)** | Logo-copy 컬러 보라(#7C3AED) 변경 | 쮸티5호 | 2026-06-16 | 【파일】`index.html` / #555→#7C3AED |
| T-038 | WT-038 | cbca6c2 | **진행중(In-Progress)** | Legal-bottom 22px + 글머리 기호 + 쌍따옴표 | 쮸티5호 | 2026-06-16 | 【파일】`index.html` / 법적고지 하단 전체 리스타일 |
| T-039 | WT-039 | cbca6c2 | **진행중(In-Progress)** | 써주세요연계대부 corp-box 22px/블랙/대표전화 | 쮸티5호 | 2026-06-16 | 【파일】`index.html` / inline style (혁사호재 미변경) |
| T-040 | WT-040 | cbca6c2 | **진행중(In-Progress)** | 통계 텍스트 "몇 만 명의 청년 서민이 빌려갔어요" | 쮸티5호 | 2026-06-16 | 【파일】`index.html` / stat-value 텍스트 변경 |
| T-041 | WT-041 | cbca6c2 | **진행중(In-Progress)** | EXPLORE 1/2/3 그룹 배너 + 컬러 코딩 | 쮸티5호 | 2026-06-16 | 【파일】`index.html` / 보라#380097/민트#A6D6DE/오렌지#FF5400 |
| T-042 | WT-042 | cbca6c2 | **진행중(In-Progress)** | 히어로 박스 연한 배경 전환 (보라/오렌지) | 쮸티5호 | 2026-06-16 | 【파일】`index.html` / 진한→연한 배경+진한 텍스트 |
| T-043 | WT-043 | cbca6c2 | **진행중(In-Progress)** | ARRIVE 클로징 배너 추가 | 쮸티5호 | 2026-06-16 | 【파일】`index.html` / 보라 배너, 클로징 이미지 상단 |
| T-044 | WT-044 | cbca6c2 | **진행중(In-Progress)** | AI 카드 "어떻게든 도와주는 AI" + 인용문 삭제 | 쮸티5호 | 2026-06-16 | 【파일】`index.html` / 타이틀 변경+card-quote 삭제 |
