...
### ⚠️ 6-⑥ 깃 관리자에게 작업 요청서 전달 (include Open PR 생성) 형식 
...
|---|---|---|---|---|---|---|---|
| T-001 | WT-001 | `8ea9643` | **배포대기** | unsuspend 랜딩페이지 신규 제작 | 쮸리1호 | 2026-05-05 12:30 | 【파일】`unsuspend/index.html`, `project-docs/10_plan/기획안_unsuspend_랜딩페이지.md` / 【작업】PDF 분석 → 기획안 작성 → HTML 신규 제작 → 폴더명 변경(이용정지해제→unsuspend) → project-docs 루트 이동 반영 → 이미지 경로 수정 / 【커밋】`8ea9643` / 【브랜치】`feature/unsuspend-landing-page` 원격 푸시 완료 |
...
| T-003 | WT-003 | - | 진행중(In-Progress) | 홈 화면 신규 제작 (SEC-01 Hero 크로스페이드 슬라이드쇼 포함) | 쮸리1호 | 2026-05-10 | 【파일】`home/index.html`, `project-docs/10_plan/기획안_home_랜딩페이지.md` / 【현재】섹션 스크린샷 이미지를 img로 잘못 사용 → 중복 표시 버그, 크로스페이드 슬라이드 미구현 / 【작업】섹션별 하나씩 수정 |
