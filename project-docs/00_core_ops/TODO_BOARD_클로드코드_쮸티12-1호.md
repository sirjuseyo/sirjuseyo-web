...
| W-085 | P1 | - | **대기** | **[챌린지 대표 페이지] challenge/index.html + index-dev.html 신규 생성** | `challenge/index.html`(신규), `challenge/index-dev.html`(신규) | 현재 챌린지 1개(월드컵)뿐 → `2026-06/index-dev.html` 내용을 챌린지 대표 페이지로 이식 / PRD + DEV 각 1개 생성 / menu.js(PRD)·menu-dev.js(DEV) 적용 | 2026-07-22 | 쮸티12-1호 |
