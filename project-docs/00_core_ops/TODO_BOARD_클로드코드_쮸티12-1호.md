...
| **T-109** | [소통거리 제출 가이드] phone-docs/index.html + job-income/index.html 신규 생성 + submissions SEC-07·10 링크 개편 | - | - | 대기(Pending) | - (웹) | - (웹) | 대기 | - (웹) | 쮸티12-1호 | 2026-07-28 | phone-docs·job-income 각 index.html+index-dev.html(신규) + SEC-07 카드3개→단일링크 + SEC-10 카드12개→단일링크 |
...
|---|---|---|---|---|---|---|---|---|
| **T-109** | - | W-109 | - | **대기(Pending)** | **[소통거리 제출 가이드] phone-docs·job-income 선택 페이지 신규 + submissions SEC 링크 개편** | 쮸티12-1호 | 2026-07-28 | 【신규】`tip/submissions/phone-docs/index.html`·`index-dev.html`, `tip/submissions/job-income/index.html`·`index-dev.html` / 【수정】`tip/submissions/index.html`·`index-dev.html` SEC-07(카드3→단일) + SEC-10(카드12→단일) + 서브페이지 data-back 경로 변경 |
...
| W-109 | P1 | T-109 | **대기** | **[소통거리 제출 가이드] phone-docs·job-income 선택 페이지 신규 생성 + submissions SEC-07·10 링크 개편** | `tip/submissions/phone-docs/index.html`(신규), `phone-docs/index-dev.html`(신규), `tip/submissions/job-income/index.html`(신규), `job-income/index-dev.html`(신규), `tip/submissions/index.html`·`index-dev.html`(수정) | 현재 SEC-07·SEC-10 섹션이 submissions/index.html 안에만 존재 / phone-docs·job-income 각각 독립 선택 페이지(+DEV) 신규 생성 후 submissions SEC 링크를 단일 index 링크로 변경 + 서브페이지 data-back 경로 갱신 | 2026-07-28 | 쮸티12-1호 |
