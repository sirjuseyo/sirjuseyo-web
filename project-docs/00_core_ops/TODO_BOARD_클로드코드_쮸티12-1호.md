...
|---|---|---|---|---|---|---|---|---|
| **T-102** | WT-115 | W-107 | - | **대기(Pending)** | **[꿀정보] 연체 이력 해제 페이지 통합 개편 (PRD 업데이트 + DEV 신규)** | 쮸티12-1호 | 2026-07-28 | 【파일】`tip/unsuspend/index.html`(PRD 수정) + `tip/unsuspend/index-dev.html`(DEV 신규) / 현황: menu.js·popup.js·legal-shared.js 미탑재, footer.js만, DEV 버전 없음, div.page → body.page 미통일 |
