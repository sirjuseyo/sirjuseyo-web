...
| T-142 | [대출 검사기] 콘텐츠 오른쪽 offset + overflow 수정 | ✅ `693966b` | ✅ PR#16 `df5489b` | ✅ 테스트완료(DONE) | - | - | 쮸티12-1호 | 2026-08-02 | `index-dev.html`+`index.html` form-grid: 1fr→minmax(0,1fr) — 이미지 min-content가 grid 트랙(480px) 초과하던 근본 원인 해결 / DEV·PRD 사장님 테스트 완료 |
