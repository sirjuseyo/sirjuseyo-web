...
| W-092 | P1 | - | **대기** | **[UI 통일] 하단 법적 고지 UI 불일치 — footer.js → legal-shared.js 교체** | `loan-match/index-dev.html`, `nanocredit/index-dev.html` | footer.js(구버전) 하단 고지 vs legal-shared.js(신버전) 혼재 → legal-shared.js로 전체 교체, 컨테이너 클래스 추가 | 2026-07-22 | 쮸티12-1호 |
