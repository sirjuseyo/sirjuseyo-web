...
| T-142 | [대출 검사기] 콘텐츠 오른쪽 offset + overflow 수정 | ✅ `a2feaf9` | - | ⏳ 진행중 | - | - | 쮸티12-1호 | 2026-08-02 | `styles.css` max-width 520→100% + overflow-x:hidden / `index-dev.html` body 480px margin:0 auto + .app-main padding-left/right:0 |
