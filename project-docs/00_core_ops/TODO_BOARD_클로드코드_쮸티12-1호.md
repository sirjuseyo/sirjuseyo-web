...
| **T-111** | [대출 가능성 검사기] Phase A 톤·비주얼 개편 | ⏳ `2c64f0f` | 대기 | 진행중(In-Progress) | - (웹) | - (웹) | 대기 | - (웹) | 쮸티12-1호 | 2026-07-29 | styles.css·index.html·index-dev.html·app.js / 기획안 §2·5·6·7 전면 적용 + 2·3회차 회차수정 완료 |
