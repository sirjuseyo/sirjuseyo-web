...
| **T-074** | WT-087 | W-079 | `1ac1630` | **코딩완료(TEST WAIT)** | **[햄버거 메뉴] menu.js B안 디자인 적용** | 쮸티12-1호 | 2026-07-17 | 【파일】`js/menu.js` / 드로어 헤더 보라 배경+"메뉴를 선택하세요.", 카드 타일 아이템, 이모지 박스, 화살표 / 메뉴명 "써주세요.가 뭔데?" 변경 |
...
| W-079 | P1 | T-074 | **코딩완료(TEST WAIT)** `1ac1630` | **[햄버거 메뉴] menu.js 디자인 UI 작업** | `js/menu.js` | nav bar + 드로어 디자인 완성 — 로고·버튼·메뉴 항목·색상·타이포·간격 등 브랜드 톤앤매너 반영 / 완성 후 전체 페이지 적용(W-080 예정) | 2026-07-17 | 쮸티12-1호 |
