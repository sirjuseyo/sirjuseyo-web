...
| **T-105** | Deep Dive apply-review-dev.html UI 통합 | ✅ `7d8da3d` | 대기 | ✅ 검증완료 | - (웹) | - (웹) | 대기 | - (웹) | 쮸티12-1호 | 2026-07-28 | s1~s5 old top-bar 제거 + popup.js 제거 / body.page+data-back+480px+dev-banner+menu-dev.js+legal-shared.js |
