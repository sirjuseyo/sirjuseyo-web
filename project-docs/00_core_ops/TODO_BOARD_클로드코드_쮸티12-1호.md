...
| **T-105** | Deep Dive apply-review-dev.html UI 통합 | ✅ `d7b6511` | 대기 | ✅ 검증완료 | - (웹) | - (웹) | 대기 | - (웹) | 쮸티12-1호 | 2026-07-28 | s1~s5 old top-bar 제거 + popup.js 제거 + tip/index-dev.html DEV 링크 정합(PRD→DEV) |
