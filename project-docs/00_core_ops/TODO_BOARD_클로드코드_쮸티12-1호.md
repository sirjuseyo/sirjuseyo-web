...
| T-142 | [대출 검사기] styles.css 콘텐츠 폭 overflow 수정 | ✅ `06f77e9` | - | ⏳ 진행중 | - | - | 쮸티12-1호 | 2026-08-02 | `tip/loan-checker/styles.css` / `.script-cta-button img max-width: min(520px,100%)→100%` + `.script-cta-button-text max-width: 520px→100%` + `body overflow-x: hidden` 추가 |
...
| W-141 | P1 | T-142 | **진행중(In-Progress)** `06f77e9` | **[대출 검사기] styles.css 콘텐츠 폭 overflow 수정** | `tip/loan-checker/styles.css` | `.script-cta-button img max-width 520px→100%` + `.script-cta-button-text max-width 520px→100%` + `body overflow-x: hidden` 추가 | 2026-08-02 | 쮸티12-1호 |
