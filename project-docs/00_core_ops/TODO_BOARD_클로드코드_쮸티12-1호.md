...
| T-142 | [대출 검사기] 콘텐츠 오른쪽 offset + overflow 수정 | ✅ `06f77e9` `078b207` | - | ⏳ 진행중 | - | - | 쮸티12-1호 | 2026-08-02 | `styles.css` max-width 520→100% + overflow-x:hidden / `index-dev.html` body max-width:480px + .app-main 100% margin:0 |
