...
|---|---|---|---|---|---|---|---|---|
| **T-105** | WT-118 | - | `480001e` | **진행중(In-Progress)** | **[Deep Dive] apply-review-dev.html UI 통합 + 진입 보안코드 overlay 구현** | 쮸티12-1호 | 2026-07-28 | 【파일】`tip/apply-review/apply-review-dev.html` / ①UI통합: max-width 520→480px, body.page+data-back="/tip/index-dev.html", DEV배너 top:52px sticky 방식 통일, popup.js+menu-dev.js+legal-shared.js 탑재 ②보안코드: 페이지 로드 시 전체화면 overlay(보라 #380097) → sjyCheckCode() 일치 시 해제 + sessionStorage('sjy-deep-dive-auth') 저장 (CODE: 20543003 하드코딩) |
