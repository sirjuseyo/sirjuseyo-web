...
|---|---|---|---|---|---|---|---|---|---|
| **T-130** | [신청 폼] 7월→8월 워딩 변경 + 이벤트 대출 30만 경고 추가 + 경고 문구 수정 | ✅ `a9b2747` | 대기 | ⏳ 테스트 대기 | - (웹) | 대기 | 쮸티12-1호 | 2026-08-01 | ①워딩 3곳 7→8월 ②selectMethodEvent 30만 경고 조건 추가 ③warn-method-amount `10,20,30만`→`10,20만` / 사장님 테스트 대기 |
| **T-129** | [대출 검사기] 상단 안내 문구 워딩 수정 | ✅ `189ae41` | 대기 | ✅ 테스트완료(DONE) | - (웹) | 대기 | 쮸티12-1호 | 2026-08-01 | `대출을 받을 수 있는 [써주세요. 앱…]은` → `[써주세요. 앱…]을` / `이 검사기는` → `대출 가능성 검사기는` / 사장님 VS Code Live Server 테스트 완료 |
| **T-128** | [8월 대출 페이지] 대표 거절 사유 4번 문구 수정 | ✅ `6f857fd` | 대기 | ✅ 테스트완료(DONE) | - (웹) | 대기 | 쮸티12-1호 | 2026-08-01 | `1년 이내 3개월 이상 무직 또는 과거 6개월 이상 무직` → `최근 3개월 이상 무직 또는 과거 6개월 이상 무직` + em `노동 상태와 의지를 중요시 여깁니다.` / 사장님 VS Code Live Server 테스트 완료 |
| **T-127** | [대출 검사기] 대표 거절 사유 4번 추가 | ✅ `ded299d` | 대기 | ✅ 테스트완료(DONE) | - (웹) | 대기 | 쮸티12-1호 | 2026-08-01 | ①⑦안내섹션 ②결과패널 2곳 / `최근 3개월 이상 무직 또는 과거 6개월 이상 무직` + em `노동 상태와 의지를 중요시 여깁니다.` / 사장님 VS Code Live Server 테스트 완료 |
| **T-126** | [대출 검사기] 30만 원 이벤트 대출 비활성 + 문구 수정 | ✅ `a5562d8` | 대기 | ✅ 테스트완료(DONE) | - (웹) | 대기 | 쮸티12-1호 | 2026-08-01 | ①30만 원 선택 시 이벤트 대출 disabled ②eventAmountNote 문구 수정 / 사장님 VS Code Live Server 테스트 완료 |
...
| T-088 | [UI 통일] 상단 고지↔콘텐츠 간격 규격 통일 | ✅ `c69f2c9` `c401d33` | - | 테스트 완료(DONE) | - | - | 쮸티12-1호 | 2026-07-25 07:59 | legal-shared.js margin-bottom 20px→40px + index.html h1 padding-top 0 — 전 페이지 gap 40px 통일 |
| T-089 | [UI 통일] JS 연결 순서 표준화 | ✅ `e2fb46b` | - | 테스트 완료(DONE) | - | - | 쮸티12-1호 | 2026-07-25 14:08 | tip/index-dev.html 순서 교체 + challenge/index-dev.html legal-shared.js 이동·중복 제거 |
| T-090 | [PRD 레이아웃] loan-checker PRD 앱 사이즈 480px 적용 | ✅ `412c3c2` | - | 테스트 완료(DONE) | - | - | 쮸티12-1호 | 2026-07-25 20:54 | loan-checker/index.html <head> 인라인 스타일 추가 — .app-main max-width:480px DEV와 동일 |
| T-091 | [PRD 정합] 대출 가능성 검사기 PRD → DEV 정합 (이미지 제거 + 1열) | ✅ `aee1e72` | - | 테스트 완료(DONE) | - | - | 쮸티12-1호 | 2026-07-25 21:14 | loan-checker/index.html — ①loan-eligibility-checker-02.jpg display:none 숨김 ②.form-grid 1열 인라인 추가, DEV와 동일, styles.css 무수정 |
| T-092 | [DEV 배너 정합] loan-checker DEV 바 앱 사이즈(480px) + 스크롤 고정 | ✅ `b549c35` | - | 테스트 완료(DONE) | - | - | 쮸티12-1호 | 2026-07-25 21:50 | loan-checker/index-dev.html — DEV 배너 div에 position:sticky;top:52px;z-index:10000;max-width:480px;margin:0 auto; 5속성 추가, tip/challenge 규격 정합, DEV 전용 |
| T-093 | [DEV 배너 정합] nanocredit·loan-match DEV 바 앱 사이즈(480px) 고정 | ✅ `4fef5cf` | - | 테스트 완료(DONE) | - | - | 쮸티12-1호 | 2026-07-25 22:05 | nanocredit/index-dev.html, loan-match/index-dev.html — 두 배너 div에 max-width:480px;margin:0 auto; 2속성 추가, 전 DEV 배너 규격 통일, DEV 전용 |
| T-100 | [나노크레딧] "이 달의 대출 신청하러 가기" 링크 수정 (PRD+DEV) | ✅ `29a7ec0` | - | 테스트 완료(DONE) | - | - | 쮸티12-1호 | 2026-07-26 | nanocredit/index.html href="/"→"/monthly-loan/2026-07/" / nanocredit/index-dev.html href="/index-dev.html"→"/monthly-loan/2026-07/index-dev.html" |
| T-099 | [나노크레딧] 상품 상세 페이지 전면 개편 (10/20/30/50 — 4개 파일) | ✅ `af2879c` | - | 테스트 완료(DONE) | - | - | 쮸티12-1호 | 2026-07-26 | nanocredit/10·20·30·50 전면 개편: ①써주세요. title ②body 480px ③구 nav CSS 제거 ④class=page+data-back=/nanocredit/ ⑤nav HTML 제거 ⑥CTA→/monthly-loan/2026-07/ ⑦popup.js+menu.js+legal-shared.js / 회차수정: class=page+popup.js+legal-shared.js 추가(`b50cd97`) |
| T-098 | [메뉴 드로어] 드로어 본체 480px 제한 — PC 전체 화면 덮음 수정 (B안) | ✅ `95b6cf0` | - | 테스트 완료(DONE) | - | - | 쮸티12-1호 | 2026-07-26 | #sjy-drawer left:50%;max-width:480px + translateX(calc(50vw+10px)→-50%) / 회차수정: 200%→vw단위 |
| T-097 | [메뉴 드로어] 헤더 풀사이즈 → 앱 사이즈(480px) 고정 | ✅ `2ffda52` | - | 테스트 완료(DONE) | - | - | 쮸티12-1호 | 2026-07-26 | #sjy-drawer-head에 max-width:480px;margin:0 auto;width:100% 추가 |
| T-096 | [디렉토리 개편 3단계] apply-review·loan-checker·unsuspend → tip/ 하위 통합 | ✅ `69e20e2` | - | 테스트 완료(DONE) | - | - | 쮸티12-1호 | 2026-07-26 | git mv 3개 + 참조 수정 7건: index(-dev).html, tip/index(-dev).html, tip/unsuspend/index.html img 4곳 |
| T-094 | [디렉토리 개편 1단계] 월별대출 2026-04~07 + apply → monthly-loan/ 하위 통합 | ✅ `bc93486` | - | 테스트 완료(DONE) | - | - | 쮸티12-1호 | 2026-07-25 22:45 | git mv 5개(`2026-04/05/06/07`,`apply/` → `monthly-loan/`) + 참조 수정 다수: index(-dev).html, menu(-dev).js, loan-checker, challenge, nanocredit, monthly-loan/apply, 2026-06 / 스테일 도메인 → 루트 상대경로 통일 |
| T-095 | [잠복 버그 수정] menu.js·menu-dev.js `history.back()` → `window.history.back()` 한정 | ✅ `af48274` | - | 테스트 완료(DONE) | - | - | 쮸티12-1호 | 2026-07-26 | js/menu.js, js/menu-dev.js — apply.html `const history=[]` shadowing 버그 수정, 2파일 105행 `window.history.back()` 한정 |
...
| T-087 | [UI 통일] W-092 PRD footer.js → legal-shared.js 교체 | ✅ `c88a8ad` `d4ec4a9` | - | 테스트 완료(DONE) | - | - | 쮸티12-1호 | 2026-07-25 07:14 | loan-match·nanocredit PRD body class="page" 추가 + legal-shared.js 연결 / 상단·하단 법적 고지 정상 표시 확인 |
| T-086 | [UI 통일] W-091 ← 버튼 통합 + 크기·센터 + apply data-back | ✅ `95a9815` `e671798` | - | 테스트 완료(DONE) | - | - | 쮸티12-1호 | 2026-07-25 06:05 | menu.js·menu-dev.js ← 1.8rem·sjy-has-back 로고 센터 / apply PRD·DEV data-back 추가 / 14개 하위 페이지 data-back / nanocredit·loan-match 기존 BACK 제거 |
| T-085 | [UI 통일] W-090 tip→loan-checker DEV 링크 수정 | ✅ `3d9e7e4` | - | 테스트 완료(DONE) | - | - | 쮸티12-1호 | 2026-07-25 05:30 | tip/index-dev.html href="/loan-checker/" → "/loan-checker/index-dev.html" |
| T-084 | [UI 통일] legal-shared.js 상단 고지 풀사이즈 통일 | ✅ `9c117ea` `e73d94b` `222ce6d` `fad4793` | - | 테스트 완료(DONE) | - | - | 쮸티12-1호 | 2026-07-22 | 총 4커밋 / 회차1: legal-shared.js 수정 / 회차수정: DEV 바 컨테이너 이동 + nanocredit·loan-match legal-shared.js 교체 / 회차수정2: DEV 바 body 직하위 이동(overflow:hidden 대응) / 회차수정3: DEV 바 감지 로직 복원 + 월별 대출 padding-top 제거 |
| T-083 | [꿀정보] tip/index.html + tip/index-dev.html 신규 생성 | ✅ `38da632` | - | 테스트 완료(DONE) | - | - | 쮸티12-1호 | 2026-07-22 09:50 | tip/ 폴더 신규, popup.js·menu-dev.js·legal-shared.js 연결, DEV 배너 삽입 |
| T-082 | [전체 팝업] popup.js IIFE 분리 + ID 충돌 수정 | ✅ `61bb08b` | - | 테스트 완료(DONE) | - | - | 쮸티12-1호 | 2026-07-22 | popup.js 신규, menu #sjy-menu-overlay ID 변경, index-dev.html OLD 팝업 254줄 제거 |
| T-081 | [팝업 오버레이] 내비바 가림 문제 수정 — top:52px | ✅ `61bb08b` | - | 테스트 완료(DONE) | - | - | 쮸티12-1호 | 2026-07-22 | js/popup.js inset:0 → inset:52px 0 0 0 |
| T-080 | [menu-dev.js] DEV 전용 메뉴 JS 신규 생성 + 전체 DEV 파일 적용 | ✅ `6015e2b` | - | 테스트 완료(DONE) | - | - | 쮸티12-1호 | 2026-07-21 | js/menu-dev.js 신규 + DEV 파일 7개 적용 |
...
| T-074 | [햄버거 메뉴] menu.js B안 디자인 적용 | ✅ `e833bdc` | - | 테스트 완료(DONE) | - | - | 쮸티12-1호 | 2026-07-20 | #sjy-menu * 리셋 선택자 우선순위 충돌 수정 — 코덱스 진단, 카드 padding/margin 0 덮어쓰기 버그 해결 |
| T-073 | [메인 DEV 팝업] 재노출 방지 활성화 하루 1회 (W-078) | ✅ `9bf803d` | - | 테스트 완료(DONE) | - | - | 쮸티12-1호 | 2026-07-17 | index-dev.html localStorage sjy_popup_hidden 체크·저장 로직 추가 |
| T-072 | [햄버거 메뉴] menu.js + 1Depth 메뉴 UI 구현 (W-077) | ✅ `0d26a54` | - | 테스트 완료(DONE) | - | - | 쮸티12-1호 | 2026-07-17 | js/menu.js 신규, sirjuseyo/ 폴더명 변경, index-dev.html nav 제거 + menu.js 적용, z-index 10001·10002, 햄버거 버튼 2rem |
...
|---|---|---|---|---|---|---|---|---|
| **T-130** | WT-141 | W-130 | - | **진행중** | **[신청 폼] 7월→8월 워딩 변경 + 이벤트 대출 30만 경고 추가 + 경고 문구 수정** | 쮸티12-1호 | 2026-08-01 | 【파일】`monthly-loan/apply/apply-dev.html`, `apply.html` / ①h1·고객안내·API 7→8월 워딩 ②selectMethodEvent 30만 경고 조건 추가 ③warn-method-amount `10,20,30만`→`10,20만` / 로컬커밋 `a9b2747` / 사장님 테스트 대기 |
...
| W-130 | P1 | T-130 | **진행중** | **[신청 폼] 7월→8월 워딩 변경 + 이벤트 대출 30만 경고 추가 + 경고 문구 수정** | `monthly-loan/apply/apply-dev.html`, `apply.html` | ①h1·고객안내·API 7→8월 워딩 ②selectMethodEvent `50만` 조건에 `30만` 추가 ③warn-method-amount `10,20,30만`→`10,20만` / 로컬커밋 `a9b2747` / 사장님 테스트 대기 | 2026-08-01 | 쮸티12-1호 |
