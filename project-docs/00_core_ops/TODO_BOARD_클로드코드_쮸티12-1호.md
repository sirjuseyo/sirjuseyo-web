...
| W-123 | P1 | - | **대기** | **[8월 대출] 썸머 베케이션 Ⅱ 대출 페이지 신규 생성 (index-dev.html) + CURRENT_MONTH 전환** | `monthly-loan/2026-08/index-dev.html`, `index.html`, `js/menu.js`, `js/menu-dev.js`, `tip/loan-checker/month-config.js` | 기획서 v0.4 기반 — ①2026-08/index-dev.html 신규 생성 (7월 파일 기반, 8월 변동 사항 전면 반영) ②CURRENT_MONTH='2026-08' 전환 ③month-config.js 2026-08 객체 추가 / CLAUDE.md 3단계 체크리스트 동시 처리 필수 | 2026-07-30 | 쮸티12-1호 |
