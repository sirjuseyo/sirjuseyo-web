...
| T-087 | [UI 통일] W-092 PRD footer.js → legal-shared.js 교체 | ✅ `c88a8ad` | - | 진행중(In-Progress) | - | - | 쮸티12-1호 | 2026-07-25 | 【파일】`loan-match/index.html`, `nanocredit/index.html` / footer.js 주석 처리 + legal-shared.js 추가 |
