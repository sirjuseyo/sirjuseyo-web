...
|---|---|---|---|---|---|---|---|---|---|
| **T-128** | [8월 대출 페이지] 대표 거절 사유 4번 문구 수정 | 대기 | 대기 | ⏳ 대기 | - (웹) | 대기 | 쮸티12-1호 | 2026-08-01 | `1년 이내 3개월 이상 무직 또는 과거 6개월 이상 무직` → `최근 3개월 이상 무직 또는 과거 6개월 이상 무직` + em `노동 상태와 의지를 중요시 여깁니다.` / 대출 가능성 검사기와 동일 문구로 통일 / 목차컨펌 대기 |
...
|---|---|---|---|---|---|---|---|---|
| **T-128** | WT-139 | W-128 | - | **대기(Pending)** | **[8월 대출 페이지] 대표 거절 사유 4번 문구 수정** | 쮸티12-1호 | 2026-08-01 | 【파일】`monthly-loan/2026-08/index-dev.html`, `index.html` / `1년 이내`→`최근` 문구 수정 + em 추가 / 목차컨펌 대기 |
...
| W-128 | P1 | T-128 | **대기** | **[8월 대출 페이지] 대표 거절 사유 4번 문구 수정** | `monthly-loan/2026-08/index-dev.html`, `index.html` | `1년 이내 3개월 이상 무직 또는 과거 6개월 이상 무직` → `최근 3개월 이상 무직 또는 과거 6개월 이상 무직` + em `노동 상태와 의지를 중요시 여깁니다.` / 대출 가능성 검사기 동일 문구 통일 / 목차컨펌 대기 | 2026-08-01 | 쮸티12-1호 |
