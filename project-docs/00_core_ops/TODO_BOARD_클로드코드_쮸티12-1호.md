...
| T-142 | [대출 검사기] 콘텐츠 오른쪽 offset + overflow 수정 | ✅ `06f77e9` `078b207` `cb339fb` | - | ⏳ 진행중 | - | - | 쮸티12-1호 | 2026-08-02 | `styles.css` max-width 520→100% + overflow-x:hidden / `index-dev.html` body max-width:480px margin:0 auto + .app-main 100% margin:0 |
...
| W-141 | P1 | T-142 | **진행중(In-Progress)** `06f77e9` `078b207` | **[대출 검사기] 콘텐츠 오른쪽 offset + overflow 수정** | `tip/loan-checker/styles.css`, `tip/loan-checker/index-dev.html` | styles.css: max-width 520→100% + overflow-x:hidden / index-dev.html: body max-width:480px + .app-main 100% margin:0 | 2026-08-02 | 쮸티12-1호 |
