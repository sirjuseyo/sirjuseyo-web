...
| **T-088** | WT-102 | W-094 | `c69f2c9` | **진행중(In-Progress)** | **[UI 통일] W-094 상단 고지↔콘텐츠 간격 통일 — legal-shared.js margin-bottom:20px** | 쮸티12-1호 | 2026-07-25 07:45 | 【파일】`js/legal-shared.js` / `.legal-top` CSS에 `margin-bottom:20px` 추가 — 전 페이지 일괄 적용 |
...
| W-094 | P1 | T-088 | **진행중(In-Progress)** `c69f2c9` | **[UI 통일] 상단 고지 ↔ 콘텐츠 간격 불일치** | `js/legal-shared.js`, `index-dev.html`, `sirjuseyo/index-dev.html`, `tip/index-dev.html` | legal-shared.js `.legal-top` CSS에 `margin-bottom` 없음 → `margin-bottom: 20px` 추가로 일괄 해결 (loan-checker·2026-07·challenge는 파일 내 override 이미 적용 중) | 2026-07-22 | 쮸티12-1호 |
