...
|---|---|---|---|---|---|---|---|---|
| **T-101** | WT-114 | W-106 | - | **진행중(In-Progress)** | **[나노크레딧 상세] 수치 전면 업데이트 — 7월 썸머 베케이션 기준 반영 (10/20/30/50 — 4개 파일)** | 쮸티12-1호 | 2026-07-26 | 【파일】`nanocredit/10/index.html`, `20/index.html`, `30/index.html`, `50/index.html` / ①크레딧 미션 4,500포 공통 통일 ②이벤트 대출 이포 유지 + 원금 미션(1%) 수치 추가 ③50만 이벤트 행 삭제 ④비교 테이블 전 행 합계 재계산 ⑤웨이팅 보상 할인 테이블 4,500포 기준 통일 ⑥한도상향 크레딧 미션 수치 수정 |
