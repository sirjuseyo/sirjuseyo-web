...
| **T-108** | [소통거리 제출 가이드] 등·초본 → 초본 텍스트 수정 | ✅ `b37d348` | - | 진행중(DEV) | - (웹) | - (웹) | 대기 | - (웹) | 쮸티12-1호 | 2026-07-28 | tip/submissions/index.html·index-dev.html SEC-14 / 섹션제목·소제목·③항목 "등본+초본"→"초본"만 |
...
|---|---|---|---|---|---|---|---|---|
| **T-108** | WT-121 | W-108 | `b37d348` | **진행중(In-Progress)** | **[소통거리 제출 가이드] 등·초본 → 초본 텍스트 수정** | 쮸티12-1호 | 2026-07-28 | 【파일】`tip/submissions/index.html`, `tip/submissions/index-dev.html` / SEC-14 섹션제목(📋 등·초본→초본) + 소제목(등·초본 제출하는 방법→초본 제출하는 방법) + ③항목(등본과 초본 각각→초본을) |
