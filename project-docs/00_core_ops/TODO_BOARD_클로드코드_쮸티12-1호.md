...
|---|---|---|---|---|---|---|---|---|---|
| **T-130** | [신청 폼] 7월→8월 워딩 변경 + 이벤트 대출 30만 경고 추가 + 경고 문구 수정 | 대기 | 대기 | ⏳ 대기 | - (웹) | 대기 | 쮸티12-1호 | 2026-08-01 | ①워딩 3곳 7→8월 ②30만 선택+이벤트대출 경고 추가 ③경고문구 `10,20,30만` → `10,20만` / 목차컨펌 대기 |
...
|---|---|---|---|---|---|---|---|---|
| **T-130** | WT-141 | W-130 | - | **대기(Pending)** | **[신청 폼] 7월→8월 워딩 변경 + 이벤트 대출 30만 경고 추가 + 경고 문구 수정** | 쮸티12-1호 | 2026-08-01 | 【파일】`monthly-loan/apply/apply-dev.html`, `apply.html` / ①7월→8월 워딩 3곳 ②selectMethodEvent 30만 경고 조건 추가 ③warn-method-amount 문구 `10,20,30만`→`10,20만` / 목차컨펌 대기 |
...
| W-130 | P1 | T-130 | **대기** | **[신청 폼] 7월→8월 워딩 변경 + 이벤트 대출 30만 경고 추가 + 경고 문구 수정** | `monthly-loan/apply/apply-dev.html`, `apply.html` | ①h1·현재고객님·API 3곳 7→8월 워딩 ②selectMethodEvent 30만 경고 조건 추가 ③warn-method-amount 문구 수정 / 목차컨펌 대기 | 2026-08-01 | 쮸티12-1호 |
