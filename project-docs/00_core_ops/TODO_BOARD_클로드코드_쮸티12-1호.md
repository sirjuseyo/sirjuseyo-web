...
| **T-113** | [홈 화면] 히어로 영역 문구 변경 (앱 동일) | ⏳ `7fdde17` | 대기 | 진행중(In-Progress) | - (웹) | - (웹) | 대기 | - (웹) | 쮸티12-1호 | 2026-07-30 | index.html·index-dev.html h1+p.sub 앱 동일 변경 / 2회차: 면책 문구 추가 + cream 색상 제거 |
